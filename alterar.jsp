...
<h2>${msg}</h2>
<div class="container">
<form class="form-horizontal" role="form" method="post" action="usuarioendereco.alterar.action">
	 <input class="form-control" type="hidden" name="usuario.codUsuario" value="${usuario.codUsuario}">
	  <input class="form-control" type="hidden" name="endereco.codEndereco" value="${endereco.codEndereco}">
    <div class="form-group">
      <label>Matricula</label>
      <input class="form-control" type="text" name="usuario.matricula" value="${usuario.matricula}" readonly="true">
    </div>
    <div class="form-group">
      <label>Nome</label>
    ...
    <div class="form-group">
      <label>Email</label>
      <input class="form-control" type="email" name="usuario.email" value="${usuario.email}">
    </div>
    <div class="form-group">
      <label>Senha</label>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="text" name="usuario.telefone" value="${usuario.telefone}"/>
    </div>
    <label>Perfil</label>
