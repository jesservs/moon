...
<h3><span class="label label-default">${msg}</span></h3>
	<form class="form-horizontal" role="form" method="post" action="noticia.cadastrar.action">
	    <div class="form-group">
	      <label>Título</label>
	      <input class="form-control" type="text" name="noticia.titulo">
	    </div>
	    <div class="form-group">
	      <label>Descrição</label>
			<input type="text"
	               ...
	               name="noticia.descricao" 
	       />
	    </div>
	    <div class="form-group">
	      <label>Foto</label>
	      <input class="form-control" type="file" name="noticia.foto">
	    </div>
